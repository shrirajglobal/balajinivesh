  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        <p className="mt-1">
          Past performance is not indicative of future returns. Balaji Nivesh Private Limited is an AMFI-registered Mutual Fund Distributor | ARN-173142. It is a Mutual Fund
