    ...
    <div className="container max-w-4xl py-12 lg:py-16">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground [&_h2]:mb-3 [&_h2]:font-display [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-foreground [&_ul]:ml-5 [&_ul]:list-disc [&_ul]:space-y-1">
        ...
        <section className="rounded-lg border border-primary/20 bg-primary/5 p-6">
          ...
          <p>
            <strong>Balaji Nivesh Private Limited</strong> is an <strong>AMFI-registered Mutual Fund Distributor | ARN-173142</strong>. We are <strong>not</strong> a SEBI-registered Investment Adviser under the SEBI (Investment Advisers) Regulations, 2013, nor a SEBI-registered Research Analyst under the SEBI (Research Analysts) Regulations, 2014, nor a SEBI-registered Portfolio Manager under the SEBI (Portfolio Managers) Regulations, 2020.
          </p>
        </section>
