          ...
          {!user && (
            <div className="mb-8 rounded-xl border border-secondary/20 bg-accent p-4 text-center">
              <p className="text-sm text-foreground">
                ...
                <Link to="/auth?mode=distributor&returnTo=%2Feducation%2Fkids" className="font-medium text-secondary underline">Sign in</Link> to track your missions, earn a certificate &amp; win a gift!
              </p>
            </div>
          )}
