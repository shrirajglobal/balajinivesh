          ...
          {!user && (
            <div className="mb-8 rounded-xl border border-primary/20 bg-brand-orange-light p-4 text-center">
              <p className="text-sm text-foreground">
                ...
                <Link to="/auth?mode=distributor&returnTo=%2Feducation%2Fhomemakers" className="font-medium text-primary underline">Sign in</Link> to track your progress, earn a certificate &amp; claim a gift!
              </p>
            </div>
          )}
