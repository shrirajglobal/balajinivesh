...
const Dashboard = () => {
  ...
  return (
    <PartnerLayout>
      <h1 className="font-display text-2xl font-bold text-foreground">{t("partnerDash.title")}</h1>
      <p className="mt-1 text-muted-foreground">{t("partnerDash.welcome")}</p>
      ...
      <div className="mt-8 rounded-xl border border-border bg-card p-6">
        <p className="text-sm text-muted-foreground">{t("partnerDash.dataNote")}</p>
      </div>
    </PartnerLayout>
  );
};
